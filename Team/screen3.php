...
?>
        ...
        <div class="dropdown" >
  <button class="btn btn-primary dropdown-toggle btn-block" style="background-color: black;color: white" type="button" data-toggle="dropdown">Select Trip
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    
    <?php
    $result = mysqli_query($con,"SELECT name FROM provider_estimate;");
