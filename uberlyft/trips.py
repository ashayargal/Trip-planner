...
dba = create_engine('mysql+pymysql://root:admin@localhost/googlemaps')
dba.echo = False
...
class locations(db.Model):
    ...
    def save_locations():
                ...
                new_location=locations(name=None,address=None,city=None,state=None,zip=None,latitude=None,longitude=None,trip_order=order_id,trip_name=name)
...
def copy_location(old_location,new_location):
            ...
            old_location.trip_order = new_location.trip_order
